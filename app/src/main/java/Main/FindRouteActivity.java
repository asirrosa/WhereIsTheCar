...
public class FindRouteActivity extends AppCompatActivity implements LocationListener, NetworkStateReceiver.NetworkStateReceiverListener, View.OnClickListener, OnMapReadyCallback, MenuItem.OnMenuItemClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, style -> {
            style.addImage("symbolIconId", BitmapFactory.decodeResource(FindRouteActivity.this.getResources(), R.drawable.mapbox_marker_icon_default));
    ...
    public void navDialog() {
        ...
        FindRouteDialog findRouteDialog = new FindRouteDialog(this);
        //para que aun clicando el back button o fuera del dialog este no se cierre
        findRouteDialog.setCancelable(false);
        findRouteDialog.show(getSupportFragmentManager(), "example dialog");
    }
